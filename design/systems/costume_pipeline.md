...
| `jiangyun_rainbow` | 绛云霓裳 | 女 | `game-client/assets/art/costumes/jiangyun_rainbow/concept/jiangyun_rainbow_concept_v01.png` | 概念已审核；南向待机生产候选已抠图，其余七方向、行走、攻击动作待制作，尚不可接入地图 |
