...
|---|---|---|---|---|
| `liulan_wayfarer` | 流岚游衣 | 男 | `game-client/assets/art/costumes/liulan_wayfarer/concept/liulan_wayfarer_concept_v01.png` | 概念已审核；八方向待机、正南/西南/正西/西北六帧行走透明源图已通过，其余方向行走与攻击动作待制作 |
