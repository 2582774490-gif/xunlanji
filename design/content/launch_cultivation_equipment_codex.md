...
首发大类已冻结为 24 种：剑、刀、枪、戟、斧、锤、棍、鞭、弓、弩、扇、伞、琴、箫、铃、符笔、阵盘、傀儡、鼎、珠、印、镜、塔、轮。每类均已有第一把“练气基础器型”的命名、战斗倾向和三条大分支；青篁练气剑、回云练气伞、朱砂练气符笔、流云练气枪、逐风练气弓、断雾练气刀、玄月练气戟、开山练气斧已具备独立运行时素材与动作。流云练气枪采用独立长兵姿态、较远枪刺距离与直线“破雾枪势”；逐风练气弓采用独立持弓姿态、箭矢弹道与远射技能；玄月练气戟采用独立钩斩姿态与半圆戟势，定位在刀与枪之间的中距离压迫；开山练气斧采用明显较慢的重劈姿态与裂地震击，换取近身单次高压制。远程命中会激活敌人的反击距离，避免无伤站桩；其他器型仍需逐把完成独立武器卡、攻击动作和特效，不能以同一把剑贴图替代。
