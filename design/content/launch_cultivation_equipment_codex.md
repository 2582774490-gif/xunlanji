...
首发大类已冻结为 24 种：剑、刀、枪、戟、斧、锤、棍、鞭、弓、弩、扇、伞、琴、箫、铃、符笔、阵盘、傀儡、鼎、珠、印、镜、塔、轮。每类均已有第一把“练气基础器型”的命名、战斗倾向和三条大分支；青篁练气剑、回云练气伞、朱砂练气符笔已具备独立运行时素材与动作。流云练气枪已完成原始武器图与透明资源，仍待长兵动作、刺击特效和运行时测试；其他器型仍需逐把完成独立武器卡、攻击动作和特效，不能以同一把剑贴图替代。
...
6. **流云练气枪**：单体长兵武器图；已生成并抠图，下一轮制作刺击动作、长兵距离判定与枪势特效。
...
| 流云练气枪 | `assets/art/weapons/liuyun_qi_spear/processed_alpha/liuyun_qi_spear_v01_alpha.png` | 已完成原创长兵图与透明资源；待独立长兵动作、刺击特效、范围规则和武器卡接入 |
