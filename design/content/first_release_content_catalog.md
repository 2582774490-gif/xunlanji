...
- **可用**：已有游戏数据、获得方式或交易入口；若标明“独立美术”，则已可在界面中显示。
- **待独立美术**：玩法和世界定位已冻结，不能拿其他道具的图片顶替。
- **世界预留**：为筑基以上内容保留，暂不加入炼气期开服掉落池。

所有物品在正式联网版均可自由交易；死亡不掉落。PVE 防护效果不进入当前本地 1v1 PVP，避免付费或掉落带来数值压制。

## 一、功法总表

| 派系 | 功法 | 适配倾向 | 核心定位 | 美术状态 |
|---|---|---|---|---|
| 五行正修 | 金阙破锐诀、青木回生篇、玄水引潮经、赤焰炼息法、厚土镇元诀 | 五行灵根 | 破锐、恢复、御水、炼火、镇压 | 待独立秘卷 |
...
| 境界 | 法宝 | 槽位 | 主要用途 | 状态 |
|---|---|---|---|---|
| 炼气 | 纳灵玉佩 | 护身 | 稳定灵力恢复 | 可用，独立美术 |
| 炼气 | 潮息玉佩 | 护身 | 温和灵力恢复 | 可用，独立美术 |
| 炼气 | 雾潮炼气珠 | 御水 | 水系 PVE 护持 | 可用，独立美术 |
| 炼气 | 玄土炼气印 | 镇压 | 土岩 PVE 护持 | 可用，独立美术 |
| 炼气 | 八角炼气阵盘 | 阵势 | 常规 PVE 护阵 | 可用，独立美术 |
| 炼气 | 照影炼气镜 | 鉴别 | 幻雾线索与隐藏裂隙 | 可用，独立美术 |
| 炼气 | 妖将护符 | 妖猎 | 妖类首领 PVE 护持 | 可用，独立美术 |
| 筑基 | 归潮白螺、青灯养魂灯、赤炉温养鼎 | 御水 / 守识 / 丹器 | 地区与专业分支 | 世界预留 |
| 结丹以上 | 四象镇岳图、霜河寒魄匣、地火玄甲环、千机巢游傀、天游裂风轮、镇妖九宫塔 | 多槽位 | 区域探索与高阶副本 | 世界预留 |
...
| 炼气丹药 | 灵泉露、凝息丹、养元丹、归元丹 | 分别服务炼气前、中、后期；高阶服用低阶无效 | 灵泉露通过灵泉机缘、采集或交易获得；三种丹药可炼制；四者均已独立美术 |
...
| 项目 | 内容 |
|---|---|
| 物品定位 | 炼气四至六层的中期丹药，修为 +22，药负 +7 |
| 配方 | 雾泽灵草 × 1 + 雾林材料 × 1 + 凝气符材 × 1 |
...
- 万物图鉴会按七大修行派系列出全部首发功法：每条都显示适配灵根、体质和美术状态；未有独立秘卷图时明确标注，绝不借用其他功法图片。
- 炼气丹药会按实际药性列出；灵泉露、凝息丹、养元丹、归元丹均展示独立图卡。灵泉露是自然灵液，可经灵泉机缘、采集或交易获得；其余三种为可炼制丹药。

## 四之二、本轮 Image 2 交付：灵泉露

| 项目 | 内容 |
|---|---|
| 物品定位 | 炼气一至九层可用的温和灵液，修为 +15，药负 +2。 |
| 获得逻辑 | 雨后灵泉、雾地探索、采集与自由交易；不伪装成炼制丹药。 |
| 源图 | `game-client/assets/art/pills/spirit_spring_dew/source/spirit_spring_dew_v01_chromakey.png` |
| 透明游戏图 | `game-client/assets/art/pills/spirit_spring_dew/processed_alpha/spirit_spring_dew_v01_alpha.png` |
| 实装位置 | 修炼界面服用逻辑、万物图鉴丹药卡片与自动资源验收。 |
- 法宝、护具和 24 种基础器型保持各自独立资源与动作，不使用同一张图假装多个物件。
