...
func _population_profiles() -> Array[Dictionary]:
	return [
		...
		{
			"id": "yunlan_reverse_rune_seeker", "region": "yunlan_outskirts", "sector": "stonebud_highland", "kind": "rogue", "name": "逆纹寻碑客",
			"prompt": "与寻碑客比对反向器纹", "chance": 1.0, "story_stance": "seeker",
		...
		{
			"id": "yunlan_mist_dew_recorder", "region": "yunlan_outskirts", "sector": "cloudfoot_wood", "kind": "rogue", "name": "雾露记事人",
			"prompt": "查看记事人的雾露簿", "chance": 1.0, "story_stance": "witness",
