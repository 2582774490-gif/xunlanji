...
func _population_profiles() -> Array[Dictionary]:
	return [
		...
		# These are deliberately sparse, stance-sensitive witnesses. They do not
		# grant rewards or create a quest chain: the same ridge answers a player
		# differently according to the provisional view they have already formed.
		{"id": "ridge_gate_relay_warden", "region": "ancient_ridge", "kind": "rogue", "name": "护路驿修", "prompt": "询问护路驿修关于古脊关道的撤离记录", "chance": 0.54, "anchors": [Vector2(1180, 1320), Vector2(1660, 1460)], "story_stance": "mender", "story_trace": "road", "story_note": "护路驿修把地火裂谷外的绕行线与药车名单并列写在木牌上。古脊岭的旧界异常先改变的，是仍要穿过关道的人。", "story_branch": "mender_ridge_relay_route", "story_branch_title": "古脊护路牌", "story_branch_description": "你记下古脊关道的护路名单：守界并不是把人留在门外，而是让他们在异象中仍有一条可以返回的路。", "tint": Color(0.62, 0.82, 0.76), "label_color": Color(0.74, 0.94, 0.86)},
		{"id": "ridge_fragment_cartographer", "region": "ancient_ridge", "kind": "rogue", "name": "断台测界师", "prompt": "询问断台测界师关于断碑坐标的推断", "chance": 0.49, "anchors": [Vector2(4180, 2460), Vector2(4940, 2640)], "story_stance": "seeker", "story_trace": "relic", "story_note": "断台测界师将断碑台地的缺角和旧界坐标逐一比对。他相信岚潮不是要人守住边界，而是在催促人追问边界最初为何被划下。", "story_branch": "seeker_ridge_fragment_map", "story_branch_title": "断台测界图", "story_branch_description": "你在残碑之间复核了几处坐标。溯源不是寻找现成的答案，而是承认每一条界线都曾被人重新丈量。", "tint": Color(0.78, 0.68, 0.96), "label_color": Color(0.90, 0.80, 1.0)},
		{"id": "ridge_ash_ledger_keeper", "region": "ancient_ridge", "kind": "rogue", "name": "灰盆记火人", "prompt": "询问记火人关于灰烬盆地的异动笔记", "chance": 0.43, "anchors": [Vector2(1880, 3720), Vector2(3160, 4100)], "story_stance": "witness", "story_trace": "relic", "story_note": "灰盆记火人只记录灰层、蒸汽、兽迹和风向，从不替异象下结论。他说旧界显形时，最怕的不是变化，而是有人急着替所有人把变化解释成同一种东西。", "story_branch": "witness_ridge_ash_ledger", "story_branch_title": "灰盆异动簿", "story_branch_description": "你抄下灰烬盆地的连续观测。观变不是袖手旁观，而是在判断尚未成熟前，替世界留下不被抹平的细节。", "tint": Color(0.92, 0.68, 0.48), "label_color": Color(1.0, 0.80, 0.60)},
		{"id": "ridge_pass_wayfarer", "region": "ancient_ridge", "kind": "rogue", "name": "关隘归山客", "prompt": "与归山客谈论古战关隘的门规残碑", "chance": 0.38, "anchors": [Vector2(6060, 1780), Vector2(6840, 2020)], "story_requires_thread_category": "sect", "story_trace": "relic", "story_note": "归山客从你留下的山门经历里听出你见过门规的重量。他指向关隘残碑：旧界边缘当年也有不同宗门各自立下的规矩，而那些规矩未必比人的去留更久。", "story_branch": "sect_ridge_pass_stela", "story_branch_title": "关隘门规残碑", "story_branch_description": "你以亲历过的山门关系读懂了残碑上的争执。它不替你评价任何宗门，只让古脊岭的旧事与自己的经历彼此照见。", "tint": Color(0.70, 0.80, 0.98), "label_color": Color(0.80, 0.88, 1.0)},
	]
